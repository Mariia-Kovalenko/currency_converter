...
export const CURR_IDS = [
  {
    id: UAH_ID, code: CurrencyCodes.UAH
  },
  {
    id: EUR_ID, code: CurrencyCodes.EUR
  },
  {
    id: USD_ID, code: CurrencyCodes.USD
  },
]
...
export const indexes = [
    ...
    {
      id: EUR_ID, code: CurrencyCodes.EUR, coef: 0.2
    },
    {
      id: USD_ID, code: CurrencyCodes.USD, coef: 0.3
    },
  ]
